...
def lowestMonthly(balance, annualInterestRate):
    ...
    while True:
        ...
        print("Equal? " + str(guessPaymentUpperBound == guessPaymentLowerBound))
        if abs(guessPaymentUpperBound - guessPaymentLowerBound) <= .01:
            break
